...
//         answer = "not working";
// }
// console.log(answer); //one will be outputted if answer is declared
...
//         answer = "not working";
// }
// console.log(answer); //it will console this is the one
...
//     "login";
// console.log(userOkay); //login will be outputted
...
// }
// console.log(htmlOutput + ": " + userInput); // it will output "Welcome, that is a user";
...
// }
// console.log(output); //wake up it is morning it is morning;
